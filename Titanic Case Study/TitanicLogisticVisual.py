...
def MarvellousTitanicLogistic(Datapath):
    ...
    print("Dimensions of adatsest",df.shape)
    ...
    figure()
    target ="Survived"
    countplot(data=df,x=target,hue="Sex").set_title("Base on Gender")
    #show()

    figure()
    target ="Survived"
    countplot(data=df,x=target,hue="Pclass").set_title("Base on Pclass")
    #show()
    ...
    print("Deminsions of target:-",x.shape)
